...
/* src/components/Counter.svelte generated by Svelte v3.54.0 */
...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			...
			attr(button0, "class", "svelte-1pvjoqw");
			attr(strong0, "class", "hidden svelte-1pvjoqw");
			attr(strong0, "aria-hidden", "true");
			attr(strong1, "class", "svelte-1pvjoqw");
			attr(div0, "class", "counter-digits svelte-1pvjoqw");
			set_style(div0, "transform", "translate(0, " + 100 * /*offset*/ ctx[2] + "%)");
			attr(div1, "class", "counter-viewport svelte-1pvjoqw");
			attr(button1, "aria-label", "Increase the counter by one");
			attr(button1, "class", "svelte-1pvjoqw");
			attr(div2, "class", "counter svelte-1pvjoqw");
		},
		m(target, anchor) {
...
register({ _Users_jobayerhossain_Documents__repo_production_ready_svelteKit_src_components_Counter_svelte: Counter });
//# sourceMappingURL=index-1ab04337.js.map
